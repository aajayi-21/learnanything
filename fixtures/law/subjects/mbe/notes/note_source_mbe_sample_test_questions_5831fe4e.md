---
schema_version: 1
id: note_source_mbe_sample_test_questions_5831fe4e
subjects:
  - mbe
related_los: []
related_concepts: []
...
canonical_source:
  kind: website_page
  original_uri: 
    file:///home/chloe/Documents/thinking/learnanything/learnanything/fixtures/law/MBE_Sample_Test_Questions.md
  canonical_uri: 
    file:///home/chloe/Documents/thinking/learnanything/learnanything/fixtures/law/MBE_Sample_Test_Questions.md
  title: MBE Sample Test Questions
  authors: []
  retrieved_at: '2026-05-31T19:54:09Z'
  content_hash: 
    sha256:5831fe4ebe26280a2ca5d3e7f1af932773e4b8567fea89c087a70951d90fc311
  license_hint:
created_at: '2026-05-31T19:54:09Z'
updated_at: '2026-05-31T19:54:09Z'
---

# MBE Sample Test Questions

**Source:** National Conference of Bar Examiners, *MBE Sample Test Questions*
**Copyright:** Copyright © 2016 by the National Conference of Bar Examiners. All rights reserved.
**Note:** The following sample questions are examples of test questions similar to those on the MBE. While these sample questions illustrate the kinds of questions that will appear on the MBE, they do not represent all the material covered. Examinees are advised to review the information on MBE content, including the MBE Subject Matter Outline. To model the pacing required to complete a full MBE, these questions should be answered in approximately 38 minutes. An answer key follows at the end.
...
A woman from State A filed an action against a retailer in a state court in State B. The complaint alleged that the retailer had not delivered $100,000 worth of goods for which the woman had paid.

Twenty days after being served, the retailer, which is incorporated in State C and has its principal place of business in State B, filed a notice of removal in a federal district court in State B.
...
Twenty-three years ago, a woman who owned a tract of land in fee simple absolute deeded it to her son "and his heirs, so long as the premises are used for residential purposes." A one-story building located on the land was used by the son as his home for the next 11 years.

Twelve years ago, the son conveyed the land to a friend, who immediately began to use it for commercial purposes and continued to do so until her death four years ago. The friend died intestate, and the land passed to her sole heir, who went into immediate possession and at all times thereafter has used the land for commercial purposes.

The period of time to acquire a title by adverse possession in the jurisdiction is 10 years. There are no other applicable statutes.

The woman has sued the friend's heir for possession.

In this action, who will prevail?

- **(A)** The heir, because she has a fee simple absolute in the land.
- **(B)** The heir, because she has a fee simple determinable in the land.
- **(C)** The woman, because her cause of action against the heir did not begin until the heir inherited the land from the friend.
- **(D)** The woman, because once the friend began to use the land for commercial purposes, the friend's interest became uninheritable.

### 13.

A state law prohibits any barbershop licensed by the state from displaying posters in support of any current candidate for public office or displaying or distributing any campaign literature in support of such a candidate. No other kinds of posters or literature are subject to this prohibition, nor are any other types of commercial establishments in the state subject to similar prohibitions.
...
The president was convicted of murder. On appeal, he argues that his conviction should be reversed.
